    ...
    .then(data => {
        data.forEach( e => {
            ...
            serviceHTML += `<div class="services">
                            <a href=""><img src="../img/servicesImg/${e.serviceImage}" alt="service-Photo Mirror Spa"></a>
                            <div class="serviceDetails">
                                <a href=""><h2>${e.serviceName.length > 25 ?  e.serviceName.substring(0, 24) + '...' : e.serviceName}</h2></a>
